...
public class Lambaithitoeic extends HttpServlet 
{
			...
			throws ServletException, IOException 
	{
		...
		if (session.getAttribute("sessionuser")!=null)
		{
			...
			List<CauHoi> list = LambaithiDAO.Hienthicauhoidethi(conn, examinationid);
		...
		{
			request.setAttribute("msgloidnlambai","lỗi ah you");
			...
			throws ServletException, IOException 
	{
		...
		int countrow = LambaithiDAO.Demsocauhoidethi( examinationid);
		
		
		List<CauHoi> listcorrectanswer = LambaithiDAO.Xuatdapandungdethi(conn, examinationid);
