		  ...
		  <!-- /. PAGE TITLE-->
			...
			<div class="row">	
					<c:forEach items="${danhsachdethi}" var="list1">
						<div class="span6">			
								<div class="media">
									 <a href="#" class="pull-left"><img src="Template/img/anh3.jsp" class="media-object" alt='' width="128px" height="128px"/></a>
					...
					<div class="pagination">
						<ul>
							<c:if test="${numberpage == 1}">
							   ...
							   <li><a href = "Hienthidsdethi?pageid=${numberpage+1}">Next</a></li>
						   </c:if>
						   <c:if test="${numberpage == maxpageid}">
							   <li><a href = "Hienthidsdethi?pageid=${numberpage-1}">Prev</a></li>
