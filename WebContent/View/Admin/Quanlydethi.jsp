...
<title>Quản lý danh sách đề thi</title>
...
<body class="no-skin">	
								...
								<div class="col-xs-12">
											...
											<table id="simple-table" class="table  table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">
															Checked câu hỏi đề thi
														</th>
													</tr>
												</thead>
												<tbody>
													
													<c:forEach items="${danhsachdethi}" var ="listdt">
														<tr>
															<td class="center">
																${listdt.examinationid}
															</td>
															<td class="center">
																${listdt.examinationame}
															</td>
															<td class="center">
																
																<img src="Imageaudiodethi/${listdt.examinatioimage}">
															</td>
															...
															<td class="center">
																<a class="green" href="Themcauhoidethi?examinationid=${listdt.examinationid}">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
															</td>
															<td class="center">
																<ul class="list-unstyled">
																	<c:if test="${listdt.checkedcauhoi==1}">
																		<li>
																			<i class="ace-icon fa fa-check-square-o"></i>														
																		</li>	
																	</c:if>	
																	<c:if test="${listdt.checkedcauhoi==0}">
																		<li>
											...
											<div>
												<ul class="pagination">
													<c:if test="${numberpage == 1}">
													   ...
													   <li><a href = "Hienthidsquanlydethi?pageid=${numberpage+1}">Next</a></li>
												   </c:if>
												   <c:if test="${numberpage == maxpageid}">
													   <li><a href = "Hienthidsquanlydethi?pageid=${numberpage-1}">Prev</a></li>
									...
									<div class="row">
										<div class="col-xs-12">
											...
											<a href="Themaudiohinhanhdethi" role="button" class="btn btn-white btn-warning btn-bold">Thêm audio và hình ảnh đề thi</a>
	  ...
	  <div class="modal fade" id="myModal" role="dialog">
	    ...
	    <form action="Themtendethi" method="POST">
		      <!-- Modal content-->
