                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="InsertDeThi"  method="post">   
                    <div class="form-group">
                      ...
                      <input  type="text"  class="form-control" id="exampleInputName1" value="<%=rs.getString("tendethi")%>" name="isdethi" >
                    </div>
                    
                    <div class="form-group" style="float:left">
                     <label for="exampleInputCity1">Số Câu Dễ </label>
				      <select value="<%=rs.getString("socaude")%>"  class="form-control" id="sel1" name="issocaude" style="width:90px" >
				        <option>1</option>
				        <option>2</option>
				        <option>3</option>
				        <option>4</option>
                    ...
                    <div class="form-group" style="float:left;margin-left:80px">
                     <label for="exampleInputCity1">Số Câu Trung Bình </label>
				      <select  value="<%=rs.getString("socautrungbinh")%>" class="form-control"  id="sel1" name="issocautrungbinh"  style="width:90px">
				        <option>1</option>
				        <option>2</option>
				        <option>3</option>
				        <option>4</option>
                   ...
                   <div class="form-group" style="clear:both;margin-left:80px">
                    <label for="exampleInputCity1">Số Câu Khó</label>
				       <select value="<%=rs.getString("socaukho")%>" class="form-control" id="sel1" name="issocaukho" style="width:90px">
				        <option>1</option>
				        <option>2</option>
				        <option>3</option>
				        <option>4</option>
                    ...
                    <div class="form-group">
                      ...
                      <input  type="date" value="<%=rs.getString("thoigianmode")%>" class="form-control" id="exampleInputCity1" placeholder="Location" name="isthoigianmode"
                       style="width:280px">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputCity1">Thời Gian Làm Bài</label>
                       <select value="<%=rs.getString("thoigianlambai")%>" class="form-control" id="sel1" name="isthoigianlambai"style="width:280px">
				        <option>10</option>
				        <option>1000</option>
				        <option>2000</option>
				        <option>3000</option>
                    ...
                    <label for="exampleInputCity1">Chọn Lớp Làm Bài Thi</label>
				       <select value="<%=rs.getString("lopID")%>" class="form-control" id="sel1" name="isloplambai" style="
width:90px">
				        <option>1</option>
				        <option>2</option>
				        <option>3</option>
