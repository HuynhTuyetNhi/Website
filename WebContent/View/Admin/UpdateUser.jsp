              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="UpdateUser"  method="POST">
                   <c:forEach items="${listMemBer1}" var="list1" > 
                    <div class="form-group">
                      <label for="exampleInputName1">Name</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="ishoten" value=" ${list1.name}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Member name</label>
                      <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Email" name="istendn" value="${list1.membername}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Member pass</label>
                      <input type="password" class="form-control" id="exampleInputPassword4" placeholder="Password" name="ismatkhau" value="${list1.memberpass}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputCity1" placeholder="Location" name="islop" value="${list1.IDLop}">
                    </div>
                   <div class="form-group">
                      <label for="exampleInputCity1">Ngày sinh</label>
                      <input type="date" class="form-control" id="exampleInputCity1" placeholder="Location" name="isngaysinh" value="${list1.ngaySinh}">
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputCity1">Số điện thoại</label>
                      <input type="text" class="form-control" id="exampleInputCity1" placeholder="Location" name="isdt" value="${list1.phone}">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputCity1">Địa chỉ</label>
                      <input type="text" class="form-control" id="exampleInputCity1" placeholder="Location" name="isdc"value="${list1.diaChi}">
                    </div>
                    <div class="form-group">
                     
                      <input type="hidden" class="form-control" id="exampleInputCity1" placeholder="Location" name="isid"value="${list1.memberid}">
                    </div>
